...
namespace ARQ_Model.Protocols
{
    ...
    public class StopAndWaitProtocol : Protocol
    {
        ...
        {
            if (Filename != null) FileWriter.WriteLine($"Using {ChecksumGenerator}, " + 
        ...
        {
            if (Filename != null) FileWriter.WriteLine($"Transmitting packet #{requestNumber}.");
        ...
        {
            if (Filename != null) FileWriter.WriteLine($"ACK acquired for #{requestNumber}");
        ...
        {
            if (Filename != null) FileWriter.WriteLine("ACK timeout. Resending packet.");
